...
const NOT_SDK_SURFACE = {
  ...
  listMachineBoards: "hub machine API-key surface for boards (SDK clients land separately)",
  createMachineBoard: "hub machine API-key surface for boards (SDK clients land separately)",
  getMachineBoard: "hub machine API-key surface for boards (SDK clients land separately)",
  updateMachineBoard: "hub machine API-key surface for boards (SDK clients land separately)",
  deleteMachineBoard: "hub machine API-key surface for boards (SDK clients land separately)",
